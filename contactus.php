...
<body>
	...
	<div class="container" style="margin-bottom: 1%"><img src="img/cus.jpg" style="width: 100%"></div>
	<div class="container">
		<div class="col-md-12">
			<h2 style="text-align: center"><strong>Contact Us</strong></h2><br>
			<br>
			<div class="row text-center">
				<div class="col-md-12">
					<a href="https://api.whatsapp.com/send?phone=6285230540054"><img class="img-circle" src="img/wa.png"></a>
				...
				<div class="col-md-12">
					<br>
					<br>
					<a href="mailto:histyle@gmail.com?subject=Question%20&body=Send%20Me%20Your Question"><img class="img-circle" src="img/gmail.jpg"></a>
				...
				<div class="col-md-12">
					<br>
					<br>
					<img class="img-circle" src="img/map.jpg">
					<p><strong>Visit</strong></p>
					<p><span class="glyphicon glyphicon-home"></span> Muncar - Banyuwangi - Jawa Timur 68472</p>
					<p><span class="glyphicon glyphicon-calendar"></span> Monday - Friday</p>
					<p><span class="glyphicon glyphicon-time"></span> 9AM - 6PM</p>
				</div>
			</div>
		</div>
	</div><br>
