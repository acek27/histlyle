        ...
        <div class="panel-body">
          <form action="/action_page.php">
            <table class="table">
              ...
              <tbody>
                <tr class="success">
                  <td><img src="img/Tuneeca%201.jpg" style="width: 100px;height: 100px"></td>
                  <td>Robe</td>
                  <td>Tuneeca</td>
                  <td>Rp419.000,00</td>
                  <td>Delivered</td>
                ...
                <tr class="warning">
                  ...
                  payment<br>
                  confirmation</td>
                  <td><button class="btn btn-default">Payment<br>
                  Confirmation</button></td>
                  <td></td>
                  <td></td>
                  <td><button class="btn btn-default" disabled>Accepted</button></td>
                </tr>
                <tr class="info">
                  <td><img src="img/Tuneeca%201.jpg" style="width: 100px;height: 100px"></td>
                  <td>Robe</td>
                  ...
                  <td>089765436</td>
                  <td>J&T</td>
                  <td><button class="btn btn-default">Accepted</button></td>
                </tr>
                <tr class="danger">
                  <td><img src="img/Tuneeca%201.jpg" style="width: 100px;height: 100px"></td>
                  <td>Robe</td>
